...
(cl:defmethod cl:initialize-instance :after ((m <VelCmdGroup>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelCmdGroup)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name airsim_ros-msg:<VelCmdGroup> is deprecated: use airsim_ros-msg:VelCmdGroup instead.")))
...
(cl:defmethod vehicle_names-val ((m <VelCmdGroup>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader airsim_ros-msg:vehicle_names-val is deprecated.  Use airsim_ros-msg:vehicle_names instead.")
  (vehicle_names m))
