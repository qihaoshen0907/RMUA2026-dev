...
(defsystem "airsim_ros-srv"
  ...
  :components ((:file "_package")
    (:file "DebugSphere" :depends-on ("_package_DebugSphere"))
    (:file "_package_DebugSphere" :depends-on ("_package"))
    ...
    (:file "TriggerPort" :depends-on ("_package_TriggerPort"))
    (:file "_package_TriggerPort" :depends-on ("_package"))
  ))